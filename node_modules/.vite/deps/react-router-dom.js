...
function createRoutesStub(routes, _context) {
  return function RoutesTestStub({
    ...
    return React22.createElement(FrameworkContext.Provider, { value: frameworkContextRef.current }, React22.createElement(RouterProvider2, { router: routerRef.current }));
  };
}
...
function RouterProvider22(props) {
  return React13.createElement(RouterProvider2, { flushSync: ReactDOM.flushSync, ...props });
}
